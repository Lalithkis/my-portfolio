            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <motion.div variants={fadeInUp} className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg text-slate-600 dark:text-slate-400">
                                A showcase of my technical projects, ranging from AI systems to web applications.
                            </p>
                        </div>
                        <a href="https://github.com/Lalithkis" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all">
                    ...
                    <div className="mt-12 text-center md:hidden">
                        <a href="https://github.com/Lalithkis" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-primary font-semibold">
                            View all on GitHub <FaArrowRight />
                        </a>
                    </div>
                </motion.div>
